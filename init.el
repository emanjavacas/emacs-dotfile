...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ob-mongo inf-mongo which-key company cider sx git-timemachine git ess helm-bibtexkey helm-bibtex ac-nrepl clj-refactor eval-sexp-fu icicles doremi-frm doremi-cmd help-mode+ help-fns+ solarized-theme rfringe hc-zenburn-theme flycheck zenburn web-mode zenburn-theme powerline ac-js2 autopair js2-mode highlight-parentheses rainbow-delimiters paredit wrap-region projectile pallet ox-reveal nodejs-repl magit flycheck-pos-tip flycheck-clojure flx-ido exec-path-from-shell ack-and-a-half ac-cider))))
(custom-set-faces
...
;;;;;;;;;;;;;;;;;;;;
;; PYTHON
(setenv "PYTHONPATH" "/Users/quique/code/python")
...
(setq python-shell-prompt-detect nil)
...
(require 'ox-reveal)
(setq org-reveal-root "file:///Users/quique/.emacs.d/lisp/reveal.js-3.1.0/")
...
;;; (helm)-BIBTEX
(setq helm-bibtex-bibliography '("/Users/quique/Documents/texts/bib/mybib.bib"))
...
;;; key-bindings
(defun my-js2-keybindings ()
  "nodejs-eval-repl bindings"
  (define-key ac-js2-mode-map (kbd "C-c C-c") nil)
  (local-set-key (kbd "C-c C-c") 'nodejs-repl-eval-dwim)
  (local-set-key (kbd "C-c C-k") 'nodejs-repl-eval-buffer))
...
(defun my-js2-mode-hook ()
  "custom mode hooks for js2-mode"
...
(add-hook 'php-mode-hook 'my/php-mode-hooks)
;;; psyph
(setq psysh-comint-buffer-process "/Users/quique/.emacs.d/shell.php")
